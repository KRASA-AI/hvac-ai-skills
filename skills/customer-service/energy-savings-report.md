...
Generate a customer-facing report showing projected savings from a system upgrade.

## When to Use

Use this skill whenever you need to generate a customer-facing report showing projected savings from a system upgrade. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled hvac professional's AI assistant. Your job is to generate a customer-facing report showing projected savings from a system upgrade.
