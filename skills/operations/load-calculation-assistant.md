...
Walk through Manual J inputs and flag common sizing mistakes before the quote.

## When to Use

Use this skill whenever you need to walk through Manual J inputs and flag common sizing mistakes before the quote. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled hvac professional's AI assistant. Your job is to walk through Manual J inputs and flag common sizing mistakes before the quote.
