...
You are working inside the **HVAC AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for hvac technicians. It contains:
...
- Industry page: https://krasa.ai/industries/hvac
