...
- **June 2026 refresh of the zero-click / citation numbers (sharper than the figures above; full quarterly refresh still due 2026-07-25).** The Ahrefs December 2025 dataset (re-surfaced in June 2026 trade coverage) puts the AI-Overview click-through hit at a **58% drop** on top-ranking pages, up from 34.5% earlier in 2025; Pew measured users clicking just **8%** of the time when an AI Overview is present vs. 15% without; roughly **60%** of Google searches now end with zero clicks. AI Overviews surface on about **17.7% of home-service searches**, and some AI-generated summary appears on **~68% of local searches** overall. **1 in 3 homeowners under 45** used an AI assistant to find a home-service provider in the past 90 days. The 5W AI Visibility Index found **~78% of local-services brands are invisible to AI**. Concrete proof the old stack is insufficient: Onely's 2026 Nashville test ran HVAC/plumbing queries through ChatGPT and Perplexity and a shop with strong Google reviews and a solid map pack appeared in **neither** AI answer — map-pack position and AI citation are now two separate problems requiring two separate fixes.
...
- June 2026 zero-click / citation data re-surfacing: MarketingCode "HVAC June 2026: Tariff Cut, Price Hikes, 1.2% AI Citation" (2026-06-07); Comrade Google I/O 2026 + May 19 AI Mode breakdown (2026-06-03); Vizion Interactive CMO breakdown citing the Ahrefs December 2025 dataset (2026-06-02); Pew and Seer Interactive CTR studies; Onely 2026 Nashville HVAC/plumbing franchise analysis; 5W AI Visibility Index. ACHR News "How is AI Generative Search Impacting HVAC Companies in 2026?" (article 166230). Carried as data-point refresh; no change to tactics or schema guidance.
